...
public class FadingActionBarHelper {
    ...
    public FadingActionBarHelper headerPanelLayout(int panelResId) {
    	headerPanelResId = panelResId;
        return this;
    }
    ...
    public View createView(LayoutInflater inflater) {
        ...
        if (mContentView == null) {
            mContentView = inflater.inflate(mContentLayoutResId, null, false);
        }
        if (mHeaderView == null) {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        mInflater = inflater;
        if (mContentView == null) {
            mContentView = inflater.inflate(mContentLayoutResId, container, false);
        }
        if (mHeaderView == null) {
            mHeaderView = inflater.inflate(mHeaderLayoutResId, mHeaderContainer, false);
        }
    ...
    private View createListView(ListView listView) {
        ...
        if(headerPanelResId != 0) {
        	mMarginView = mInflater.inflate(headerPanelResId, null);
        }else{
