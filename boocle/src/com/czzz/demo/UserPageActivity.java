...
public class UserPageActivity extends AsyncTaskActivity implements
	...
	OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.user_profile_btn:
				Log.d("DEBUG", "clicked");
				Intent profileIntent = new Intent(UserPageActivity.this,
	...
	private void followUser() {
		...
		new Thread(){
			public void run(){
				...
				String str = NetworkUtils.postNetworkData(UserPageActivity.this, Pref.USER_FOLLOW_URL, params);
				Log.d("DEBUG", str);
