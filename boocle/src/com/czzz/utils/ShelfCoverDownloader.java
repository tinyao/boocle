...
public class ShelfCoverDownloader {

	Map<String, Bitmap> imageCache;
	static ShelfCoverDownloader instance;
	private static Context context;

	public static ShelfCoverDownloader getInstance() {
		if (instance == null) {
			return new ShelfCoverDownloader();
		}

		return instance;
	}

	public ShelfCoverDownloader() {
		imageCache = new HashMap<String, Bitmap>();
	}

	public ShelfCoverDownloader(int type) {
		imageCache = new HashMap<String, Bitmap>();
	}
	...
	// download function
		public void download(final DoubanBook book, final ImageView imageView) {

			context = imageView.getContext();
			
			String url = book.image;
			
			if(MyApplication.highCover
					&& !book.large_img.equals("")){
				url = book.large_img;
			}
...
//			super(Color.BLACK);
			super(BitmapFactory.decodeResource(context.getResources(), R.drawable.default_bookcover0));
