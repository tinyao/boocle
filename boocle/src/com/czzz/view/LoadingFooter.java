...
public class LoadingFooter {
    ...
    public LoadingFooter(Context context) {
        mLoadingFooter = LayoutInflater.from(context).inflate(R.layout.pulldown_footer, null);
        ...
        mProgress = (ProgressBar) mLoadingFooter.findViewById(R.id.pulldown_footer_loading);
        mLoadingText = (TextView) mLoadingFooter.findViewById(R.id.pulldown_footer_text);
